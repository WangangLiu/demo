...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select1">新闻管理</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/picture/update1.do" method="post" > 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th>图片：</th>
                                <td><input class="common-text" name="img" id="img" size="50" value="${f.img }"  type="text"></td>
                            </tr>
                            <!-- <tr>
                           ...
                           <tr>
                           <th>时间：</th>
                           <td><input type="text" name="ntime" id="ntime" value="${f.ntime } "/></td>
                           
                           </tr>
                            <tr>
                                <th>内容：</th>
                                <td>
                                <textarea class="common-textarea" name="ncontent"  id="ncontent"   cols="30" style="width: 60%;" rows="15">${f.ncontent }</textarea> </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
