...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select1">新闻管理</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/picture/add" method="post" > 
                    <table class="insert-tab" style="width: 100%" >
                        <tbody>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea class="common-textarea" name="ncontent"  id="ncontent" cols="30" style="width: 48%; height: 300px;"  ></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
