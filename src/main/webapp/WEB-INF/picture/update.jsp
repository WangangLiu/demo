...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select">作品管理</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/picture/update.do" method="post" > 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red"></i>编号：</th>
                            <td>
                               		<input class="common-text" type="text" id="keyid" value="${f.keyid }" readonly="readonly" name="keyid" /><span style="color: red;">*不可修改</span>
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>时间：</th>
                                <td><input class="common-text" name="publictime" id="publictime" size="50" value="${f.publictime }"  type="text"></td>
                            </tr>
                            <!-- <tr>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td>
                               <%--  <input type="text" class="common-text" name="pcontent" id="pcontent" value="${f.pcontent } " style=" "   size="50"/--%>
                                <textarea class="common-textarea" name="pcontent"  id="pcontent"   cols="30" style="width: 60%;" rows="15"> ${f.pcontent }</textarea> </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
