...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/pws.js"></script>
</head>
<body>
		...
		<div class="topbar-inner clearfix">
			<div class="topbar-logo-wrap clearfix">
				<ul class="navbar-list clearfix">
					<li><a class="on"
						href="${pageContext.request.contextPath}/admin/psurvey/indexa">棋牌云网站后台管理系统</a></li>
				</ul>
			</div>
			<div class="top-info-wrap">
				<ul class="top-info-list clearfix">
					<li><a
						href="${pageContext.request.contextPath}/admin/user/select7"><shiro:principal /></a></li>
					<li><a
						href="${pageContext.request.contextPath}/admin/user/logout">退出</a></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="main-wrap">
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a
						href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span
			...
			<div class="search-wrap">
				<div class="search-content">
					<form
						action="${pageContext.request.contextPath}/admin/picture/fenye"
						method="get">

						<input type="hidden" id="pageNo" name="pageNo" value="1" /> 标题：<input
							class="common-text" type="text" name="title"
							value="${sessionScope.title}" />
						<input type="button" name="btnSearch" value="查询" />
						设置当前页的数据：<input type="text" id="pageSize" name="pageSize"/>
					</form>
					<table class="search-tab">
						<tr>
							<td><a
								href="${pageContext.request.contextPath}/admin/picture/insert"><input
									class="btn btn-success btn2" name="sub" value="新增"
									type="button"></a></td>
						</tr>
					</table>
				</div>
					...
					<table class="result-tab" style="width: 100%">
						<c:forEach items="${sessionScope.list }" var="ls">
							<tr>
								...
								<td style="text-align: center; width: 51%"><a
									href="${pageContext.request.contextPath }/admin/picture/view2?keyid=${ls.keyid}">${ls.title}</a></td>
								<td style="text-align: center; width: 12%">${ls.ntime}</td>
								<td style="text-align: center; width: 17%"><a
									class="link-update"
									href="${pageContext.request.contextPath}/admin/picture/update1?keyid=${ls.keyid}">
										<input class="btn btn-primary btn2" type="button" value="修改" />
								</a> <a class="link-del"
									href="${pageContext.request.contextPath}/admin/picture/delete1?keyid=${ls.keyid}">
						...
						<tr>
							<td colspan="9" align="center" valign="middle"><a
								href="javascript:do_page(1)">首页</a>&nbsp;&nbsp;&nbsp; <a
								href="javascript:do_page(${sessionScope.pageNo-1 })">上一页</a>&nbsp;&nbsp;&nbsp;
								...
								<input type="text" id="PageNumber" size="8" />&nbsp;&nbsp; <input
								type="button" name="btnSearch" id="btnSearch" value="GO"
