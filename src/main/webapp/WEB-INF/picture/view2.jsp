...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select1">新闻管理</a><span class="crumb-step">&gt;</span><span>详情页</span></div>
        </div>
        ...
        <div class="result-wrap" style="text-align: left;">
            <div class="result-title" style="text-align:center;">
               ...
               <div class="tp" style="text-align:center; width: 570px;height:426px ;margin: auto;" >
               		<c:forEach items="${j }" var="ls">
               			<img src="http://192.168.18.115:8112/Content/Themes/Image${ls }"  />
               		</c:forEach>
               </div>
            </div>
                 <p>${f.ncontent }</p>
