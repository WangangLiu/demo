...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pnotice/select6">通知公告</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pnotice/update6.do" method="post" enctype="multipart/form-data"> 
                        ...
                        <tbody><tr>
                         ...
                         <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="publictime" name="publictime" size="50"  value="${f.publictime }"  type="text">
                                </td>
                            </tr>
                             <tr>
                                <th>内容：</th>
