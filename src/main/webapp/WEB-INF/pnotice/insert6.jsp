...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pnotice/select6">通知公告</a><span class="crumb-step">&gt;</span><span>添加</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pnotice/add6" method="post"  > 
                        ...
                        <tbody> 
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                 <textarea class="common-text" name="ncontent"  cols="30" style="width: 48%; height: 100px;" ></textarea> 
                                </td>
                            </tr>
                            <tr>
                                <th></th>
