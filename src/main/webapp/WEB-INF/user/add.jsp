		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/user/indexa">首页</a>
			...
			<div class="result-wrap">
				...
				<span><h1 style="color: red;font-size: 25px">
					...
					<form action="${pageContext.request.contextPath}/admin/user/add"
						...
						<form:form modelAttribute="userr" method="post">
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									<th width="120"><i class="require-red"></i>请设置用户名：</th>
									<td><input class="common-text" type="text" id="userName"
										name="userName" /><form:errors path="userName" cssStyle="color:red" /></td>
										
								</tr>
								<tr>
									<th><i class="require-red"></i>请设置密码：</th>
									<td><input class="common-text" type="text"
										id="userPassword" name="userPassword" /><form:errors path="userPassword" cssStyle="color:red" /></td>
