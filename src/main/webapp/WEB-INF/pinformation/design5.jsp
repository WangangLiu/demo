<%@page import="cn.acl.entity.Qpinformation"%>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">联系我们</span></div>
        </div>
            ...
            <div class="search-content">
                <form action="#" method="post">
                    <table class="search-tab">
                        <tr>
                            <td>  <a href="${pageContext.request.contextPath}/admin/pinformation/insert5"><input class="btn btn-success btn2" name="sub" value="新增" type="button"></a></td>
                        </tr>
                    </table>
                </form>
            </div>
        ...
        <div class="result-wrap">
                ...
                <table class="result-tab" style="width: 100%" >
                 <tr >
							...
							<th style="text-align: center;width:15%">QQ</th>
							<th style="text-align: center;width:15%">Email</th>
							<th style="text-align: center;width:15%">微信</th>
							<th style="text-align: center;width:15%">所属地</th>
                 ...
                 <c:forEach items="${gets }" var="ls"> 
                    <table class="result-tab" style="width: 100%">
						<tr>
							...
							<td style="text-align: center;width: 15%">${ls.phone}</td>
							<td style="text-align: center;width: 15%">${ls.qq}</td>
							<td style="text-align: center;width: 15%">${ls.email}</td>
							<td style="text-align: center;width: 15%">${ls.weixin}</td>
							<td style="text-align: center;width: 15%">${ls.address}</td>
							<td style="text-align: center;width: 15%">
							   <a class="link-update" href="${pageContext.request.contextPath}/admin/pinformation/update5?keyid=${ls.keyid}">
                              <input class="btn btn-primary btn2" type="button" value="修改"/></a>
                              <a class="link-del" href="${pageContext.request.contextPath }/admin/pinformation/delete5?keyid=${ls.keyid}">
                              <input class="btn btn-danger bth2" type="button" value="删除" onclick="return delet(); " />
                              </a>
                            </td>
						</tr>
                    </table>
