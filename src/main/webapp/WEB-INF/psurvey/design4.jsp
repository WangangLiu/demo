<%@page import="cn.acl.entity.Qpsurvey"%>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name"><a href="${pageContext.request.contextPath}/admin/psurvey/select4">概况管理</a></span></div>
        </div>
            ...
            <div class="search-content">
                <form action="#" method="post">
                    <table class="search-tab">
                        <tr>
                            <td></td>  <td></td>
                            <td>  <a href="${pageContext.request.contextPath}/admin/psurvey/insert4"><input class="btn btn-success btn2" name="sub" value="新增" type="button"></a></td>
                        </tr>
                    </table>
                </form>
            </div>
        ...
        <div class="result-wrap">
                ...
                <table class="result-tab" style="width: 100%" >
                 <tr >
							...
							<th style="text-align: center;width:45%">标题</th>
							<th style="text-align: center;width:15%">时间</th>
							<th style="text-align: center;width:18%">编辑</th>
                  </tr>
                </table>
                
                 <c:forEach items="${a }" var="ls"> 
                    <table class="result-tab" style="width: 100%">
						<tr>
							<td style="text-align: center;width: 7%">${ls.keyid}</td>
							<td style="text-align: center;width: 45%"><a href="${pageContext.request.contextPath }/admin/psurvey/view4?keyid=${ls.keyid}">${ls.title}</a></td>
							<td style="text-align: center;width: 15%">${ls.publictime}</td>
							<td style="text-align: center;width: 18%">
							   <a class="link-update" href="${pageContext.request.contextPath}/admin/psurvey/update4?keyid=${ls.keyid}">
                              <input class="btn btn-primary btn2" type="button" value="修改"/></a>
                              <a class="link-del" href="${pageContext.request.contextPath }/admin/psurvey/delete4?keyid=${ls.keyid}">
