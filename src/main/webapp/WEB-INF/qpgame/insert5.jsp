		...
		<div class="topbar-inner clearfix">
			...
			<div class="top-info-wrap">
				<ul class="top-info-list clearfix">
					<li><a
						href="${pageContext.request.contextPath}/admin/user/select7">
								<shiro:principal />
					</a></li>
					<li><a
						href="#">修改密码</a></li>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a
						...
						href="${pageContext.request.contextPath}/select">新闻管理</a><span
						class="crumb-step">&gt;</span><span>新增作品</span>
				</div>
			</div>
			<div class="result-wrap">
				<div class="result-content">
					<form action="${pageContext.request.contextPath}/admin/qpgame/add5"
						method="post">
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									<th width="120"><i class="require-red"></i>编号：</th>
									<td><input class="common-text" type="text" id="keyid"
										name="keyid" /></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>标题：</th>
									<td><textarea class="common-textarea" name="title"
								...
								<tr>
									...
									<td><input class="common-text required" id="titleimg"
										name="titleimg" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>时间：</th>
									<td><input class="common-text required" id="gtime"
										name="gtime" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>开始时间：</th>
									<td><input class="common-text required" id="starttime"
										name="starttime" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>结束时间：</th>
									<td><input class="common-text required" id="endtime"
										name="endtime" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>视频：</th>
									<td><input class="common-text required" id="video"
										name="video" size="50" value="" type="text"></td>
								</tr>
								<tr>
									<th><i class="require-red"></i>视频图片：</th>
									<td><input class="common-text required" id="videoimg"
										name="videoimg" size="50" value="" type="text"></td>
								</tr>
