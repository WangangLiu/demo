...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pinterview/select3">人物专访</a><span class="crumb-step">&gt;</span><span>添加</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pinterview/add3" method="post" enctype="multipart/form-data"> 
                    <table class="insert-tab" width="100%">
                        <tbody> 
                        	<tr>
                            <th width="120"><i class="require-red"></i>名称：</th>
                            <td>
                               		<input class="common-text" type="text" id="name" name="name" />
                            </td>
                        </tr>
                            <tr>
                            ...
                            <tr>
                                <th>内容：</th>
                                <td><textarea class="common-textarea" name="icontent"  id="icontent" cols="30" style="width: 48%; height: 300px;" ></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
