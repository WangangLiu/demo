...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pinterview/select3">人物专访</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pinterview/update3.do" method="post" enctype="multipart/form-data"> 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red"></i>编号：</th>
                            <td>
                               		<input class="common-text" type="text" id="keyid" value="${f.keyid }" name="keyid" readonly="readonly"/><span style="color: red;">*不可修改</span>
                            </td>
                        </tr>
                         <tr>
                                <th><i class="require-red">*</i>名称：</th>
                                <td>
                                    <input class="common-text required" id="name" name="name" size="50"  value="${f.name }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>标题：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50"  value="${f.title }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>图片：</th>
                                <td><input class="common-text" name="img" id="img" size="50" value="${f.img }"  type="file"></td>
                            </tr>
                            <!-- <tr>
                           ...
                           <tr>
                           <th>时间：</th>
                           <td><input type="text" name="publictime" id="publictime" value="${f.publictime } "/></td>
                           
                           </tr>
                            <tr>
                                <th>内容：</th>
                                <td>
                                <textarea class="common-textarea" name="icontent"  id="icontent"   cols="30" style="width: 60%;" rows="15">${f.icontent }</textarea> </td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
