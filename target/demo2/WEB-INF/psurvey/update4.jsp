...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/psurvey/select4">概况管理</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/psurvey/update4.do"  method="POST" > 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120">编号：</th>
                            <td>
                               		<input class="common-text" type="text"  value="${f.keyid }"  readonly="readonly" /><span style="color: red;">*不可修改</span>
                            </td>
                        </tr>
                            <tr>
                                <th>标题：</th>
                                <td>
                                    <input class="common-text required"  name="title" id="title" size="50"  value="${f.title }"  type="text">
                                </td>
                            </tr>
                           <tr>
                           <th>时间：</th>
