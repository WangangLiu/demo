...
<div class="container clearfix">
    <div class="sidebar-wrap">
        ...
        <div class="sidebar-content">
             <ul class="sidebar-list">
                ...
                <li>
                    <a href="#"c class="y"><i class="icon-font">&#xe018;</i>系统管理</a>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select7">轮播图</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/picture/update7.do" method="post" enctype="multipart/form-data"> 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                         ...
                         <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="ptype" name="ptype" size="50"  value="${f.ptype }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>图片：</th>
                                <td>
                                    <input class="common-text required" id="picture" name="picture" size="50"  value="${f.picture }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th></th>
