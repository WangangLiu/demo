		...
		<div class="main-wrap">
			...
			<div class="result-wrap">
				<div class="result-content">
					<form action="${pageContext.request.contextPath}/admin/user/ok"
						method="post">
						<table class="insert-tab" width="100%">
							<tbody>
								<tr>
									<th width="120"><i class="require-red"></i>编号：</th>
									<td><input class="common-text" type="text" id="userRoleId" readonly="readonly"
										value="${user.userId}" name="userRoleId" /><span style="color: red;">*不可修改</span></td>
								</tr>
								<tr>
								...
								<tr>
									<th><i class="require-red"></i>请选择角色身份：</th>
