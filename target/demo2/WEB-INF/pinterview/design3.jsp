<%@page import="cn.acl.entity.Qpinterview"%>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a
						...
						class="crumb-step">&gt;</span><span class="crumb-name">人物专访</span>
				</div>
			</div>
					...
					<form action="#" method="post">
						<table class="search-tab">
                            ...
                            <td><input class="common-text" placeholder="关键字" name="keywords" value="" id="" type="text"></td> -->
								...
								<td></td>
								<td><a
									href="${pageContext.request.contextPath}/admin/pinterview/insert3"><input
					...
					<c:forEach items="${gets }" var="ls">
						<table class="result-tab" style="width: 100%">
							<tr>
								...
								<td style="text-align: center; width: 10%">${ls.name}</td>
								<td style="text-align: center; width: 35%"><a
									href="${pageContext.request.contextPath }/admin/pinterview/view3?keyid=${ls.keyid}">${ls.title}</a></td>
								<td style="text-align: center; width: 15%">${ls.publictime}</td>
								<td style="text-align: center; width: 18%"><a
									class="link-update"
									href="${pageContext.request.contextPath}/admin/pinterview/update3?keyid=${ls.keyid}">
										<input class="btn btn-primary btn2" type="button" value="修改" />
								</a> <a class="link-del"
									href="${pageContext.request.contextPath }/admin/pinterview/delete3?keyid=${ls.keyid}">
