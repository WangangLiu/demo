...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
           <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pinterview/select3">人物专访</a><span class="crumb-step">&gt;</span><span>详情</span></div>
        </div>
        <div class="result-wrap">
        <div class="result-wrap" style="text-align: left;">
            <div class="result-title" style="text-align:center;">
                <h1>${f.title }</h1>
                <img alt="pws" src="http://192.168.18.115:8112/Content/Themes/Image/${f.img}">
            </div>
                 <p>${f.icontent }</p>
                 <hr/>
                 <h6>${f.publictime }</h6>
