			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a
						...
						class="crumb-step">&gt;</span><span class="crumb-name">赛事管理</span>
				</div>
			</div>
				...
				<div class="search-content">
					<form action="#" method="post">
						<table class="search-tab">
							<tr>
								<td><a
									href="${pageContext.request.contextPath}/admin/qpgame/insert9"><input
				...
				<div class="result-content">
					<table class="result-tab" style="width: 100%">
						<tr>
							...
							<th style="text-align: center; width: 40%">标题</th>
							<th style="text-align: center; width: 9%">时间</th>
					...
					<c:forEach items="${gets }" var="ls">
						<table class="result-tab" style="width: 100%">
							<tr>
								...
								<td style="text-align: center; width: 40%"><a href="${pageContext.request.contextPath}/admin/qpgame/view9?keyid=${ls.keyid}">${ls.title}</a></td>
								<td style="text-align: center; width: 9%">${ls.gtime}</td>
								<td style="text-align: center; width: 20%">
								<a class="link-update"
									href="${pageContext.request.contextPath}/admin/qpgame/update9?keyid=${ls.keyid}">
										<input class="btn btn-primary btn2" type="button" value="修改" />
								</a> <a class="link-del"
									href="${pageContext.request.contextPath }/admin/qpgame/delete9?keyid=${ls.keyid}">
