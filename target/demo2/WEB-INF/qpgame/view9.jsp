...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/picture/select1">赛事管理</a><span class="crumb-step">&gt;</span><span>详情页</span></div>
        </div>
        ...
        <div class="result-wrap" style="text-align: left;">
            <div class="result-title" style="text-align:center;">
               <h1 style="text-align:center;">${f.title }</h1>
                <img src="http://192.168.18.115:8112/Content/Themes/Image/${f.titleimg}"/>
            </div>
                 <p>${f.gcontent }</p>
                 <hr/>
                 <h6>${f.gtime }</h6>
