<%@page import="cn.acl.entity.Qpnotice"%>
...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">通知公告</span></div>
        </div>
            ...
            <div class="search-content">
                <form action="#" method="post">
                    <table class="search-tab">
                        <tr>
                            <td></td>  <td></td>
                            <td>  <a href="${pageContext.request.contextPath}/admin/pnotice/insert6"><input class="btn btn-success btn2" name="sub" value="新增" type="button"></a></td>
                        </tr>
                    </table>
                </form>
            </div>
                 ...
                 <c:forEach items="${gets }" var="ls"> 
                    <table class="result-tab" style="width: 100%">
						<tr>
							...
							<td style="text-align: center;width: 50%"><a href="${pageContext.request.contextPath }/admin/pnotice/update6?keyid=${ls.keyid}">${ls.title}</a></td>
							<td style="text-align: center;width: 20%">${ls.publictime}</td>
							<td style="text-align: center;width: 15%">
							   <a class="link-update" href="${pageContext.request.contextPath}/admin/pnotice/update6?keyid=${ls.keyid}">
                              <input class="btn btn-primary btn2" type="button" value="修改"/></a>
                              <a class="link-del" href="${pageContext.request.contextPath }/admin/pnotice/delete6?keyid=${ls.keyid}">
