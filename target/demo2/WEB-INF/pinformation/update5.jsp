...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/select5">联系我们</a><span class="crumb-step">&gt;</span><span>修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pinformation/update5.do" method="post" enctype="multipart/form-data"> 
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                         ...
                         <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="phone" name="phone" size="50"  value="${f.phone }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>QQ：</th>
                                <td>
                                    <input class="common-text required" id="qq" name="qq" size="50"  value="${f.qq }"  type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>图片：</th>
                                <td><input class="common-text" name="map" id="map" size="50" value="${f.map }"  type="file"></td>
                            </tr>
                           <tr>
                          		 <th>Email：</th>
                           <td><input type="text" name="email" id="email" value="${f.email } "/></td>
                           </tr>
                            <tr>
                                <th>微信：</th>
                                <td>
                                <input type="text" name="weixin" id="weixin" value="${f.weixin } "  size="50"/>
                            </tr>
                             <tr>
                                <th>所属地：</th>
                                <td>
                                <input type="text" name="address" id="address" value="${f.address } " size="50"/>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
