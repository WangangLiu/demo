...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="${pageContext.request.contextPath}/admin/psurvey/indexa">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="${pageContext.request.contextPath}/admin/pinformation/select5">联系我们</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/admin/pinformation/add5" method="post" enctype="multipart/form-data"> 
                    <table class="insert-tab" width="100%">
                        <tbody> 
                            <tr>
                                <th><i class="require-red">*</i>电话：</th>
                                <td>
                                    <input class="common-text required" id="phone" name="phone" size="50"   type="text">
                                </td>
                            </tr>
                             <tr>
                                <th>Email：</th>
                            ...
                            <tr>
                                <th>QQ：</th>
                                <td><input class="common-text" name="qq"  size="50" type="text"></td>
                            </tr>
                            <tr>
                                <th>微信：</th>
                                <td><input class="common-text" name="weixin" id="weixin" size="50"   type="text"></td>
                            </tr>
                               <tr>
                                <th>所属地：</th>
                               ...
                               <tr>
                                <th>Map：</th>
                                <td><input class="common-text" name="map" id="map" size="50" type="file"></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
